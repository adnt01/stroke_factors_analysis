...
## Methodology
### Steps taken:
- Data Cleaning including imputation for missing values 
- Data Exploration and Visualization 
- Logistic Regression Analysis
- Classification Modelling
  - Compare classification methods based on accuracy 
...
Results:  
- Missing data for Body Mass Index for some individuals/observations: 
- Missing values for BMI and Unknown values for Smoking Status: Requires imputation to determine the statistical significance and to        determine if the variable correlates with other variables. 
...
- [Yuli Zhang](https://drive.google.com/file/d/17TokigScW8LR8JG6w6FWjUPY4cVjETHT/view?usp=sharing)
- [Azadeh Selahvarzi](https://youtu.be/sHHkOW11EbY)
